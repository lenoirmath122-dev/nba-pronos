-- Chantier "5 majeur / banc" (GAPS_OUVERTS.md, 24/08/2026) -- même patron
-- que structured_period (migration 20260824140000) : nouvelle colonne
-- jsonb dédiée + nouveau paramètre sur update_bet_structuration().
alter table bets add column structured_roster_split jsonb;
...
-- ============================================================================
-- FIN.
-- Verif post-push : soumettre un pari 5 majeur/banc doit remplir
-- structured_roster_split en base -- necessite le deploiement Vercel
-- (structureAndScoreBet.ts transmet le nouveau parametre a tous ses appels
-- RPC, y compris les branches existantes avec p_structured_roster_split=null).
-- ============================================================================
