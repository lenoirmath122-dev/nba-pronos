> **Archive** — contenu intégral et non modifié de `ETAT_ACTUEL.md` tel qu'il existait avant la restructuration du 06/09/2026 (dérive en journal chronologique accumulé). Conservé pour référence historique uniquement ; superseded par le nouveau `Cadrage/Suivi/ETAT_ACTUEL.md` depuis le 06/09/2026. Ne pas mettre à jour ce fichier.
