...
**Résumé des décisions à implémenter (hors périmètre de ce cadrage, prochaine itération)** : ~~champ/case de déclaration d'âge au signup~~ (fait le 03/09/2026, voir point 4) ; mécanisme de signalement d'un message de chat vers les admins.
