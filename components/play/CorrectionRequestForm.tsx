import type { CorrectionRequestState, TeamRef } from "@/lib/queries/play";
...
// Requête de correction d'un prono, possible depuis les 3 états d'un match
// verrouillé (y compris un match jamais ouvert, voie A). <form action={...}>
// natif : aucun JS, erreur rendue au rechargement (portée par l'URL de
// `returnTo`, propre à l'onglet appelant — Mes pronos ou Résultats). Ex-
// components/my-predictions/CorrectionRequestForm.tsx.
...
export function CorrectionRequestForm({
  ...
  // Une requête PENDING bloque déjà côté base — on évite ici de proposer un
  // second dépôt qui échouerait forcément, sans dupliquer le garde-fou.
